...
contract FlightSuretyApp {
    ...
    /*                                       CONSTRUCTOR                                        */
    /********************************************************************************************/
    constructor (address dataContract, address firstAirline, string memory name) {
        contractOwner = msg.sender;
        flightSuretyData = FlightSuretyData(dataContract);
        // If data has 0 airlines register the founder airline at this time
        if (flightSuretyData.getNumAirlines() == 0) {
            flightSuretyData.registerFirstAirline(firstAirline, name);
        }
    }
    ...
    /********************************************************************************************/
    function registerAirline(address account, string memory name) external returns(bool success, uint256 votes) {
